...
```bash
my-efs-demo-app$ sam logs -n HelloEfsFunction --stack-name my-efs-demo-app --tail
```
...
```bash
my-efs-demo-app$ pip install -r tests/requirements.txt --user
# unit test
my-efs-demo-app$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
my-efs-demo-app$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name my-efs-demo-app
```
